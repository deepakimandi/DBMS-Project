...
<div class="wait overlay">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="panel panel-primary">
                    <div class="panel-heading"><font size = "4">Add new address</font></div>
                        <div class="panel-body">
                            <div class="row">
                            <div class="col-md-12">
                                <label for="provideaddress2"><font size = 5px >Add here</font></label><br/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label for="district22">District</label>
        ...
        <input type="submit" style="margin-left:350px;" name="edit2" class="btn btn-info btn-lg" value="Add" >
        </form>
                        </div>
                    </div>
